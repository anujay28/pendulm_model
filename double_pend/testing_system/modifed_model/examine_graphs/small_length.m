...
filename = '/home/nathanielgoldfarb/pendulm_model/double_pend/testing_system/modifed_model/tests/small_length/exo_torque.fig'
...
filename = '/home/nathanielgoldfarb/pendulm_model/double_pend/testing_system/modifed_model/tests/small_length/human_torque.fig'
fig = openfig(filename);
...
filename = '/home/nathanielgoldfarb/pendulm_model/double_pend/testing_system/modifed_model/tests/small_length/joint1_traj.fig'
fig = openfig(filename);
...
filename = '/home/nathanielgoldfarb/pendulm_model/double_pend/testing_system/modifed_model/tests/small_length/joint2_traj.fig'
fig = openfig(filename);
...
title('Torque Comparison for negative unalignment between the assistor and assistie');
